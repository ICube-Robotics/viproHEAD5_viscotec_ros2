...
#include "extruder_stepper_velocity_controller/extruder_stepper_velocity_controller.hpp"
...
namespace extruder_stepper_velocity_controller
{
using hardware_interface::LoanedCommandInterface;

ExtruderStepperVelocityController::ExtruderStepperVelocityController()
...
CallbackReturn ExtruderStepperVelocityController::on_init()
{
  try {
...
CallbackReturn ExtruderStepperVelocityController::on_configure(
...
controller_interface::InterfaceConfiguration
ExtruderStepperVelocityController::state_interface_configuration() const
{
...
CallbackReturn ExtruderStepperVelocityController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn ExtruderStepperVelocityController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

CallbackReturn ExtruderStepperVelocityController::on_cleanup(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

CallbackReturn ExtruderStepperVelocityController::on_error(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

CallbackReturn ExtruderStepperVelocityController::on_shutdown(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}
// main control loop function getting the state interface and writing to the command interface
controller_interface::return_type ExtruderStepperVelocityController::update(
...
PLUGINLIB_EXPORT_CLASS(
  extruder_stepper_velocity_controller::ExtruderStepperVelocityController, controller_interface::ControllerInterface)