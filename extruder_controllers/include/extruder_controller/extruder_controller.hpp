...
#ifndef EXTRUDER_CONTROLLER__EXTRUDER_CONTROLLER_HPP_
#define EXTRUDER_CONTROLLER__EXTRUDER_CONTROLLER_HPP_
...
{
using ControllerStateMsg = control_msgs::msg::ExtruderControllerState;
...
protected:
  ...
  std::unique_ptr<extruder_controller::ExtruderRule> extruder_;
  ...
  rclcpp::Publisher<control_msgs::msg::ExtruderControllerState>::SharedPtr s_publisher_;

  // admittance parameters
  std::shared_ptr<extruder_controller::ParamListener> parameter_handler_;
...
#endif  // EXTRUDER_CONTROLLER__EXTRUDER_CONTROLLER_HPP_
